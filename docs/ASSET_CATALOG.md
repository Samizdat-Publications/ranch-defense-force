...
7061 frame keys in `public/atlas.png`.
...
|---|---|---|---|---|---|
| `fjordPony` | `fjordPonyBlight` | **96px tall** | 25x53 | graze (9f) | white thick Fjord pony, blonde mane |
| `arabian` | `arabianBlight` | **104px tall** | 19x56 | *static* | Arabian, brown with a golden mane |
| `blackMule` | `blackMuleBlight` | **100px tall** | 28x63 | *static* | the black charge mule |
| `beigeMule` | `beigeMuleBlight` | **100px tall** | 30x62 | *static* | the beige charge mule |
| `rosie` | `rosieBlight` | **76px tall** | 24x52 | *static* | Rosie — small brown-and-white mule/donkey |
| `wiz` | `wizBlight` | **36px tall** | 16x42 | *static* | Wiz — black cat, GREEN eyes |
| `ouiji` | `ouijiBlight` | **36px tall** | 17x49 | *static* | Ouiji — black cat, YELLOW-GREEN eyes |
| `tabbyCat` | `tabbyCatBlight` | **36px tall** | 25x36 | *static* | the brown tabby |
| `siameseCat` | `siameseCatBlight` | **36px tall** | 19x42 | *static* | the white siamese |
| `joy` | `joyBlight` | **40px tall** | 29x42 | attack (9f), sit (9f) | Joy — tan-and-white bulldog, the level-up companion |
| `brahmaHen` | `brahmaHenBlight` | **40px tall** | 26x43 | peck (9f) | light Brahma, feathered feet |
| `beardedHen` | `beardedHenBlight` | **34px tall** | 24x38 | *static* | bearded Ameraucana, slate blue |
...
| `silkieHen` | `silkieHenBlight` | **30px tall** | 24x37 | *static* | Silkie — all puffy fur |
| `polishHen` | `polishHenBlight` | **34px tall** | 24x39 | *static* | Polish crested — the enormous head puff |
| `leghornHen` | `leghornHenBlight` | **36px tall** | 22x35 | *static* | white Leghorn, big floppy comb |
| `barredHen` | `barredHenBlight` | **34px tall** | 24x41 | *static* | barred Plymouth Rock |
...
## THE RANCH — generated buildings, vehicles, fencing, feed. USE THESE. — 23
