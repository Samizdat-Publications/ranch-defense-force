...
6904 frame keys in `public/atlas.png`.
...
|---|---|
| `ranch.barn` | 400x224 |
| `ranch.biplane` | 128x128 |
| `ranch.bunkhouse` | 128x128 |
| `ranch.coop` | 128x160 |
| `ranch.coopBroken` | 96x96 |
| `ranch.farmhouse` | 256x320 |
| `ranch.feedBin` | 48x48 |
| `ranch.feedBucket` | 32x32 |
| `ranch.fenceCorner` | 32x32 |
| `ranch.fencePost` | 32x32 |
| `ranch.fenceRail` | 64x96 |
| `ranch.fenceRailBroken` | 64x64 |
| `ranch.hayWagon` | 96x96 |
| `ranch.roundBale` | 64x64 |
| `ranch.roundBaleRotted` | 64x64 |
| `ranch.silo` | 224x400 |
| `ranch.squareBales` | 64x32 |
| `ranch.tractor` | 160x112 |
| `ranch.tractorRed` | 96x96 |
| `ranch.waterTrough` | 64x64 |
| `ranch.well` | 96x96 |
| `ranch.wellStone` | 96x64 |
| `ranch.windmill` | 128x128 |
