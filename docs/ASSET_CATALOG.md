...
7902 frame keys across 6 pages in `public/atlas-*.png`.
...
| `baseBreacher` | walk (8f) |
| `baseGuard` | walk (8f) |
| `baseHazmat` | walk (8f) |
| `baseOperator` | walk (8f) |
| `baseTech` | walk (8f) |
| `beardedHen` | walk (9f) |
...
| `duster` | walk (6f) |
| `farmRooster` | walk (9f) |
| `farmhandBlight` | walk (8f), hit (6f), death (7f) |
...
| `ranch.coopBroken` | 96x96 | 76x87 | **80 x 92** |
...
## LimeZu yard furniture — purchased art, being retired. Prefer `ranch.*`. — 38
...
## Field props — many with 16 variants each — 22
...
| `item.bearTrap` | 54x42 |  |  |
| `item.bloodMeal` | 37x32 |  |  |
| `item.bootKnife` | 19x62 |  |  |
| `item.broadSide` | 45x17 |  |  |
| `item.broodyHen` | 17x21 |  |  |
| `item.burrLoad` | 47x47 |  |  |
| `item.cattleProd` | 54x58 |  |  |
| `item.chalkLine` | 51x58 |  |  |
| `item.coffeeThermos` | 28x60 |  |  |
| `item.cropDuster` | 58x47 |  |  |
| `item.crossContam` | 47x43 |  |  |
| `item.culvertPipe` | 60x48 |  |  |
| `item.deepSoak` | 33x39 |  |  |
| `item.ditchLight` | 55x54 |  |  |
| `item.dogWhistle` | 61x58 |  |  |
| `item.feedSack` | 44x54 |  |  |
| `item.fenceRounds` | 53x39 |  |  |
| `item.fenceRow` | 62x48 |  |  |
| `item.fenceStaples` | 55x50 |  |  |
| `item.fontRounds` | 29x44 |  |  |
| `item.fourLeaf` | 56x60 |  |  |
| `item.gasMask` | 28x30 |  |  |
| `item.grainScoop` | 32x60 |  |  |
| `item.handbill` | 60x46 |  |  |
| `item.hobnails` | 42x62 |  |  |
| `item.hotAsItComes` | 28x61 |  |  |
| `item.keroseneCan` | 48x60 |  |  |
| `item.lampOil` | 36x62 |  |  |
| `item.lastRites` | 31x35 |  |  |
| `item.ledgerBook` | 57x42 |  |  |
| `item.limeRounds` | 41x44 |  |  |
| `item.moonshineJug` | 30x52 |  |  |
| `item.oilcloth` | 42x42 |  |  |
| `item.postDriver` | 44x60 |  |  |
| `item.ricochetPlate` | 34x34 |  |  |
| `item.rotUnderfoot` | 23x49 |  |  |
| `item.saltCircle` | 44x44 |  |  |
| `item.saltLick` | 56x60 |  |  |
| `item.saltRounds` | 32x39 |  |  |
| `item.secondPass` | 46x30 |  |  |
| `item.secondWind` | 36x59 |  |  |
| `item.seedCorn` | 60x47 |  |  |
| `item.slingBands` | 58x56 |  |  |
| `item.spareChoke` | 56x50 |  |  |
| `item.splitRail` | 59x23 |  |  |
| `item.splitShot` | 30x39 |  |  |
| `item.strawHat` | 58x59 |  |  |
| `item.sundayBest` | 60x56 |  |  |
| `item.tarRounds` | 32x37 |  |  |
| `item.threshingFloor` | 55x56 |  |  |
| `item.throughAndThrough` | 48x34 |  |  |
...
| `item.windbreak` | 44x41 |  |  |
| `item.workBoots` | 56x46 |  |  |
| `item.yardGoose` | 57x56 |  |  |
