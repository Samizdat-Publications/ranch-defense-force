...
5489 frame keys in `public/atlas.png`.
...
| `acidZombie` | walk (8f) |
| `agronomist` | walk (8f) |
| `arabianCursed` | attack (9f), death (9f), walk (9f) |
...
| `draftMuleCursed` | death (9f), attack (9f), walk (9f) |
| `drifter` | walk (8f) |
| `duckFlight` | walk (6f) |
| `duster` | walk (6f) |
| `farmhand` | walk (8f) |
| `feralDog` | death (9f), attack (9f), walk (9f) |
| `fjordPony` | graze (9f) |
