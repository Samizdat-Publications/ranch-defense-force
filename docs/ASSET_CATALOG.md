...
6279 frame keys in `public/atlas.png`.
...
| `blownSheep` | death (9f), attack (9f), hit (7f), walk (9f) |
| `brahmaHen` | peck (9f) |
| `brahmaHenBlight` | walk (9f) |
| `buffHenBlight` | walk (9f) |
| `donkeyCursed` | death (9f), attack (9f), hit (7f), walk (9f) |
...
| `fjordPony` | graze (9f) |
| `fjordPonyCursed` | attack (9f), hit (7f), death (9f), walk (9f) |
...
| `rooster` | attack (9f), hit (7f), death (9f), walk (9f) |
| `sickHog` | attack (9f), death (9f), hit (7f), walk (9f) |
